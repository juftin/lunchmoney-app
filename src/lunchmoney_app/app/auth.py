...
def get_mcp_oauth_provider(
    ...
    configuration = {
        "LUNCHMONEY_APP_OAUTH_CONFIG_URL": (resolved_settings.mcp_oauth_config_url),
        "LUNCHMONEY_APP_OAUTH_CLIENT_ID": (resolved_settings.mcp_oauth_client_id),
        "LUNCHMONEY_APP_OAUTH_BASE_URL": resolved_settings.mcp_oauth_base_url,
    }
...
async def verify_api_key(
    ...
    if request.url.path.startswith(
        ("/mcp", "/static/", "/api/docs", "/api/redoc", "/api/openapi.json")
