...
class SecretSettings(BaseSettings):
    ...
    mcp_api_key: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_API_KEY",
    ...
    mcp_oauth_client_secret: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_OAUTH_CLIENT_SECRET",
...
class OAuthSettings(BaseModel):
    ...
    mcp_oauth_config_url: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_OAUTH_CONFIG_URL",
    ...
    mcp_oauth_client_id: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_OAUTH_CLIENT_ID",
    ...
    mcp_oauth_base_url: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_OAUTH_BASE_URL",
    ...
    mcp_oauth_audience: str | None = Field(
        default=None,
        validation_alias="LUNCHMONEY_APP_OAUTH_AUDIENCE",
